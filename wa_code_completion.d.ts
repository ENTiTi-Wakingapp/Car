...
declare var Vector2: {
    prototype: Entiti.Vector2;
    new(): Entiti.Vector2;
    new(x: Number, y: Number): Entiti.Vector2;
     ...
     * @returns {Number}
     */
    dot(vec1: Entiti.Vector2, vec2: Entiti.Vector2): Number;
     ...
     * @returns {Vector2} 
     */
    lerp(from: Entiti.Vector2, to: Entiti.Vector2, t: Number): Entiti.Vector2;
    /**
     ...
     * @returns {Vector2} 
     */
    add(vec1: Entiti.Vector2, vec2: Entiti.Vector2): Entiti.Vector2;
    /**
     ...
     * @returns {Vector2} 
     */
    subtract(vec1: Entiti.Vector2, vec2: Entiti.Vector2): Entiti.Vector2;
    /**
     ...
     * @returns {Vector2} 
     */
    multiply(vec1: Entiti.Vector2, vec2: Entiti.Vector2): Entiti.Vector2;
    /**
     ...
     * @returns {Vector2} 
     */
    multiply(vec: Entiti.Vector2, scalar: Number): Entiti.Vector2;
    /**
     ...
     * @returns {Vector2} 
     */
    divide(vec: Entiti.Vector2, scalar: Number): Entiti.Vector2;
     ...
     * @returns {Number} 
     */
    distance(vec: Entiti.Vector2, vec2: Entiti.Vector2): Number;
}
...
declare namespace Entiti {
    ...
    export interface Transform {
		 ...
		 * @param {Space} space 
         */
        rotate(degress: Number, axis: Entiti.Vector3, space : Space = Space.world): void;
        /**
		 ...
		 * @param {Space} space 
         */
        translate(direction: Entiti.Vector3, space : Space = Space.world): void;
        /**
 ...
 export interface Vector2 {
         ...
         * 
         */
        add(vec: Entiti.Vector2): void;
        /**
         * Subtract vec from this vector.
         * 
         */
        subtract(vec: Entiti.Vector2): void;
        /**
         * Multiply this vector by vec.
         * 
         */
        multiply(vec: Entiti.Vector2): void;
        /**
        ...
        * @type {Vector2}
        */
        readonly normalized: Entiti.Vector2;
        /**
